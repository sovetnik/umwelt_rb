...
describe Umwelt::Files::Histories::Restore do
  subject do
    interactor.call(project_id)
  end
  let(:interactor) do
    Umwelt::Files::Histories::Restore.new(path: tmp)
  end
  ...
  let(:project) do
    { name: 'Helen', description: 'Durable Rubber Watch' }
  end
  ...
  before do
    Umwelt::Files::Histories::Store.new(path: tmp).call(project_id, history)
  end
